...
match priority:
    case "high":
        if time_bound == "yes":
            ...
            print(f"Reminder: '{task}' is a high priority task. Try to schedule it as soon as possible.")
    case "medium":
        if time_bound == "yes":
    ...
    case "low":
        if time_bound == "yes":
            ...
            print(f"Reminder: '{task}' is a low priority task. Don’t forget to do it later.")
    case _:
